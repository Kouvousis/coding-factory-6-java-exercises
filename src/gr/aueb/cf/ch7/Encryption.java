...
public class Encryption {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Your string has been encrypted successfully");
    }
    ...
    /**
     * Encodes a string input from the user by shifting the ASCII value one to the left (ASCII VALUE + 1)
     * @param inputString   the string input of the user
     * @return              the input string shifted by one to the left
     */
